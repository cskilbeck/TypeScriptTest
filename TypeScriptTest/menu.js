chs.Menu = (function () {
    ...
    var Menu = function (x, y, font, items) {
        var i,
            ht = font.height,
            w = 0,
            h,
    ...
    return chs.extend(chs.Drawable, Menu);

}());

chs.PopupMenu = (function () {
    "use strict";

    var PopupMenu = function (x, y, font, items) {
    ...
    return chs.extend(chs.Menu, PopupMenu, {
